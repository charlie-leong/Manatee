    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_lessons', models.PositiveIntegerField(choices=[(1, '1 lesson'), (2, '2 lessons'), (3, '3 lessons'), (4, '4 lessons')], default=1)),
                ('interval', models.PositiveIntegerField(choices=[(1, 'Every week'), (2, 'Every 2 weeks')], default=1, verbose_name='Interval (weeks)')),
                ('duration', models.PositiveIntegerField(choices=[(30, '30 minutes'), (45, '45 minutes'), (60, '1 hour')], default=30, verbose_name='Duration (mins)')),
                ('extra_info', models.CharField(blank=True, max_length=750, verbose_name='Extra information')),
